...
import { ResizableHandleProps, ResizableGroupProps } from './types';

const Group = ({ className, ...props }: ResizableGroupProps) => (
...
export const Resizable = { Group, Item, Handle };
